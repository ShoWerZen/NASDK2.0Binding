...
namespace KR.Neolab.Sdk.Pen {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']"
	[Register ("kr/neolab/sdk/pen/IPenAdt", "", "KR.Neolab.Sdk.Pen.IPenAdtInvoker")]
	public partial interface IPenAdt : IJavaObject {

		string ConnectedDevice {
			// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='getConnectedDevice' and count(parameter)=0]"
			[Register ("getConnectedDevice", "()Ljava/lang/String;", "GetGetConnectedDeviceHandler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")] get;
		}

		global::Android.Content.Context Context {
			// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='getContext' and count(parameter)=0]"
			[Register ("getContext", "()Landroid/content/Context;", "GetGetContextHandler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")] get;
			// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='setContext' and count(parameter)=1 and parameter[1][@type='android.content.Context']]"
			[Register ("setContext", "(Landroid/content/Context;)V", "GetSetContext_Landroid_content_Context_Handler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")] set;
		}

		global::KR.Neolab.Sdk.Pen.Penmsg.IPenMsgListener Listener {
			// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='getListener' and count(parameter)=0]"
			[Register ("getListener", "()Lkr/neolab/sdk/pen/penmsg/IPenMsgListener;", "GetGetListenerHandler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")] get;
			// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='setListener' and count(parameter)=1 and parameter[1][@type='kr.neolab.sdk.pen.penmsg.IPenMsgListener']]"
			[Register ("setListener", "(Lkr/neolab/sdk/pen/penmsg/IPenMsgListener;)V", "GetSetListener_Lkr_neolab_sdk_pen_penmsg_IPenMsgListener_Handler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")] set;
		}

		global::KR.Neolab.Sdk.Pen.Penmsg.IOfflineDataListener OffLineDataListener {
			// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='getOffLineDataListener' and count(parameter)=0]"
			[Register ("getOffLineDataListener", "()Lkr/neolab/sdk/pen/penmsg/IOfflineDataListener;", "GetGetOffLineDataListenerHandler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")] get;
			// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='setOffLineDataListener' and count(parameter)=1 and parameter[1][@type='kr.neolab.sdk.pen.penmsg.IOfflineDataListener']]"
			[Register ("setOffLineDataListener", "(Lkr/neolab/sdk/pen/penmsg/IOfflineDataListener;)V", "GetSetOffLineDataListener_Lkr_neolab_sdk_pen_penmsg_IOfflineDataListener_Handler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")] set;
		}

		int ProtocolVersion {
			// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='getProtocolVersion' and count(parameter)=0]"
			[Register ("getProtocolVersion", "()I", "GetGetProtocolVersionHandler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")] get;
		}

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='connect' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register ("connect", "(Ljava/lang/String;)V", "GetConnect_Ljava_lang_String_Handler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void Connect (string p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='disconnect' and count(parameter)=0]"
		[Register ("disconnect", "()V", "GetDisconnectHandler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void Disconnect ();

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='inputPassword' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register ("inputPassword", "(Ljava/lang/String;)V", "GetInputPassword_Ljava_lang_String_Handler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void InputPassword (string p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='isAvailableDevice' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register ("isAvailableDevice", "(Ljava/lang/String;)Z", "GetIsAvailableDevice_Ljava_lang_String_Handler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		bool IsAvailableDevice (string p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='removeOfflineData' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='int']]"
[Obsolete (@"deprecated")]
		[Register ("removeOfflineData", "(II)V", "GetRemoveOfflineData_IIHandler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void RemoveOfflineData (int p0, int p1);

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='removeOfflineData' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='int[]']]"
		[Register ("removeOfflineData", "(II[I)V", "GetRemoveOfflineData_IIarrayIHandler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void RemoveOfflineData (int p0, int p1, int[] p2);

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='reqAddUsingNote' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='int']]"
		[Register ("reqAddUsingNote", "(II)V", "GetReqAddUsingNote_IIHandler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void ReqAddUsingNote (int p0, int p1);

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='reqAddUsingNote' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='int[]']]"
		[Register ("reqAddUsingNote", "(II[I)V", "GetReqAddUsingNote_IIarrayIHandler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void ReqAddUsingNote (int p0, int p1, int[] p2);

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='reqAddUsingNote' and count(parameter)=2 and parameter[1][@type='int[]'] and parameter[2][@type='int[]']]"
		[Register ("reqAddUsingNote", "([I[I)V", "GetReqAddUsingNote_arrayIarrayIHandler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void ReqAddUsingNote (int[] p0, int[] p1);

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='reqAddUsingNote' and count(parameter)=1 and parameter[1][@type='java.util.ArrayList&lt;kr.neolab.sdk.util.UseNoteData&gt;']]"
		[Register ("reqAddUsingNote", "(Ljava/util/ArrayList;)V", "GetReqAddUsingNote_Ljava_util_ArrayList_Handler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void ReqAddUsingNote (global::System.Collections.Generic.IList<global::KR.Neolab.Sdk.Util.UseNoteData> p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='reqAddUsingNoteAll' and count(parameter)=0]"
		[Register ("reqAddUsingNoteAll", "()V", "GetReqAddUsingNoteAllHandler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void ReqAddUsingNoteAll ();

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='reqForceCalibrate' and count(parameter)=0]"
		[Register ("reqForceCalibrate", "()V", "GetReqForceCalibrateHandler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void ReqForceCalibrate ();

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='reqFwUpgrade' and count(parameter)=2 and parameter[1][@type='java.io.File'] and parameter[2][@type='java.lang.String']]"
[Obsolete (@"deprecated")]
		[Register ("reqFwUpgrade", "(Ljava/io/File;Ljava/lang/String;)V", "GetReqFwUpgrade_Ljava_io_File_Ljava_lang_String_Handler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void ReqFwUpgrade (global::Java.IO.File p0, string p1);

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='reqFwUpgrade2' and count(parameter)=2 and parameter[1][@type='java.io.File'] and parameter[2][@type='java.lang.String']]"
		[Register ("reqFwUpgrade2", "(Ljava/io/File;Ljava/lang/String;)V", "GetReqFwUpgrade2_Ljava_io_File_Ljava_lang_String_Handler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void ReqFwUpgrade2 (global::Java.IO.File p0, string p1);

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='reqOfflineData' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='int']]"
		[Register ("reqOfflineData", "(III)V", "GetReqOfflineData_IIIHandler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void ReqOfflineData (int p0, int p1, int p2);

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='reqOfflineData' and count(parameter)=4 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='int[]']]"
		[Register ("reqOfflineData", "(III[I)V", "GetReqOfflineData_IIIarrayIHandler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void ReqOfflineData (int p0, int p1, int p2, int[] p3);

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='reqOfflineDataList' and count(parameter)=0]"
		[Register ("reqOfflineDataList", "()V", "GetReqOfflineDataListHandler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void ReqOfflineDataList ();

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='reqOfflineDataList' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='int']]"
		[Register ("reqOfflineDataList", "(II)V", "GetReqOfflineDataList_IIHandler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void ReqOfflineDataList (int p0, int p1);

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='reqOfflineDataPageList' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='int']]"
		[Register ("reqOfflineDataPageList", "(III)V", "GetReqOfflineDataPageList_IIIHandler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void ReqOfflineDataPageList (int p0, int p1, int p2);

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='reqPenStatus' and count(parameter)=0]"
		[Register ("reqPenStatus", "()V", "GetReqPenStatusHandler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void ReqPenStatus ();

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='reqSetUpPasswordOff' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register ("reqSetUpPasswordOff", "(Ljava/lang/String;)V", "GetReqSetUpPasswordOff_Ljava_lang_String_Handler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void ReqSetUpPasswordOff (string p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='reqSetupAutoPowerOnOff' and count(parameter)=1 and parameter[1][@type='boolean']]"
		[Register ("reqSetupAutoPowerOnOff", "(Z)V", "GetReqSetupAutoPowerOnOff_ZHandler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void ReqSetupAutoPowerOnOff (bool p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='reqSetupAutoShutdownTime' and count(parameter)=1 and parameter[1][@type='short']]"
		[Register ("reqSetupAutoShutdownTime", "(S)V", "GetReqSetupAutoShutdownTime_SHandler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void ReqSetupAutoShutdownTime (short p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='reqSetupPassword' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String']]"
		[Register ("reqSetupPassword", "(Ljava/lang/String;Ljava/lang/String;)V", "GetReqSetupPassword_Ljava_lang_String_Ljava_lang_String_Handler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void ReqSetupPassword (string p0, string p1);

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='reqSetupPenBeepOnOff' and count(parameter)=1 and parameter[1][@type='boolean']]"
		[Register ("reqSetupPenBeepOnOff", "(Z)V", "GetReqSetupPenBeepOnOff_ZHandler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void ReqSetupPenBeepOnOff (bool p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='reqSetupPenCapOff' and count(parameter)=1 and parameter[1][@type='boolean']]"
		[Register ("reqSetupPenCapOff", "(Z)V", "GetReqSetupPenCapOff_ZHandler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void ReqSetupPenCapOff (bool p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='reqSetupPenHover' and count(parameter)=1 and parameter[1][@type='boolean']]"
		[Register ("reqSetupPenHover", "(Z)V", "GetReqSetupPenHover_ZHandler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void ReqSetupPenHover (bool p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='reqSetupPenSensitivity' and count(parameter)=1 and parameter[1][@type='short']]"
		[Register ("reqSetupPenSensitivity", "(S)V", "GetReqSetupPenSensitivity_SHandler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void ReqSetupPenSensitivity (short p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='reqSetupPenTipColor' and count(parameter)=1 and parameter[1][@type='int']]"
		[Register ("reqSetupPenTipColor", "(I)V", "GetReqSetupPenTipColor_IHandler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void ReqSetupPenTipColor (int p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='reqSuspendFwUpgrade' and count(parameter)=0]"
		[Register ("reqSuspendFwUpgrade", "()V", "GetReqSuspendFwUpgradeHandler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void ReqSuspendFwUpgrade ();

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='setAllowOfflineData' and count(parameter)=1 and parameter[1][@type='boolean']]"
		[Register ("setAllowOfflineData", "(Z)V", "GetSetAllowOfflineData_ZHandler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void SetAllowOfflineData (bool p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='setDotListener' and count(parameter)=1 and parameter[1][@type='kr.neolab.sdk.pen.penmsg.IPenDotListener']]"
		[Register ("setDotListener", "(Lkr/neolab/sdk/pen/penmsg/IPenDotListener;)V", "GetSetDotListener_Lkr_neolab_sdk_pen_penmsg_IPenDotListener_Handler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void SetDotListener (global::KR.Neolab.Sdk.Pen.Penmsg.IPenDotListener p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='setOfflineDataLocation' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register ("setOfflineDataLocation", "(Ljava/lang/String;)V", "GetSetOfflineDataLocation_Ljava_lang_String_Handler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void SetOfflineDataLocation (string p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='kr.neolab.sdk.pen']/interface[@name='IPenAdt']/method[@name='startListen' and count(parameter)=0]"
		[Register ("startListen", "()V", "GetStartListenHandler:KR.Neolab.Sdk.Pen.IPenAdtInvoker, NASDK2.0Binding")]
		void StartListen ();

	}

	[global::Android.Runtime.Register ("kr/neolab/sdk/pen/IPenAdt", DoNotGenerateAcw=true)]
	internal class IPenAdtInvoker : global::Java.Lang.Object, IPenAdt {

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("kr/neolab/sdk/pen/IPenAdt", typeof (IPenAdtInvoker));
		...
		public static IPenAdt GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<IPenAdt> (handle, transfer);
		}
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "kr.neolab.sdk.pen.IPenAdt"));
			return handle;
		}
		...
		public IPenAdtInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
...
#pragma warning disable 0169
		...
		{
			global::KR.Neolab.Sdk.Pen.IPenAdt __this = global::Java.Lang.Object.GetObject<global::KR.Neolab.Sdk.Pen.IPenAdt> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		IntPtr id_reqForceCalibrate;
		public unsafe void ReqForceCalibrate ()
		{
			if (id_reqForceCalibrate == IntPtr.Zero)
				id_reqForceCalibrate = JNIEnv.GetMethodID (class_ref, "reqForceCalibrate", "()V");
			JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_reqForceCalibrate);
		}
...
#pragma warning disable 0169
		...
		static void n_ReqFwUpgrade_Ljava_io_File_Ljava_lang_String_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0, IntPtr native_p1)
		{
			global::KR.Neolab.Sdk.Pen.IPenAdt __this = global::Java.Lang.Object.GetObject<global::KR.Neolab.Sdk.Pen.IPenAdt> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			...
			__this.ReqFwUpgrade (p0, p1);
		}
#pragma warning restore 0169

		IntPtr id_reqFwUpgrade_Ljava_io_File_Ljava_lang_String_;
		public unsafe void ReqFwUpgrade (global::Java.IO.File p0, string p1)
		{
			if (id_reqFwUpgrade_Ljava_io_File_Ljava_lang_String_ == IntPtr.Zero)
				id_reqFwUpgrade_Ljava_io_File_Ljava_lang_String_ = JNIEnv.GetMethodID (class_ref, "reqFwUpgrade", "(Ljava/io/File;Ljava/lang/String;)V");
			IntPtr native_p1 = JNIEnv.NewString (p1);
			JValue* __args = stackalloc JValue [2];
			__args [0] = new JValue ((p0 == null) ? IntPtr.Zero : ((global::Java.Lang.Object) p0).Handle);
			__args [1] = new JValue (native_p1);
			JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_reqFwUpgrade_Ljava_io_File_Ljava_lang_String_, __args);
			JNIEnv.DeleteLocalRef (native_p1);
		}
...
#pragma warning disable 0169
		...
		static void n_ReqFwUpgrade2_Ljava_io_File_Ljava_lang_String_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0, IntPtr native_p1)
		{
			global::KR.Neolab.Sdk.Pen.IPenAdt __this = global::Java.Lang.Object.GetObject<global::KR.Neolab.Sdk.Pen.IPenAdt> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Java.IO.File p0 = global::Java.Lang.Object.GetObject<global::Java.IO.File> (native_p0, JniHandleOwnership.DoNotTransfer);
			string p1 = JNIEnv.GetString (native_p1, JniHandleOwnership.DoNotTransfer);
			__this.ReqFwUpgrade2 (p0, p1);
		}
#pragma warning restore 0169

		IntPtr id_reqFwUpgrade2_Ljava_io_File_Ljava_lang_String_;
		public unsafe void ReqFwUpgrade2 (global::Java.IO.File p0, string p1)
		{
			if (id_reqFwUpgrade2_Ljava_io_File_Ljava_lang_String_ == IntPtr.Zero)
				id_reqFwUpgrade2_Ljava_io_File_Ljava_lang_String_ = JNIEnv.GetMethodID (class_ref, "reqFwUpgrade2", "(Ljava/io/File;Ljava/lang/String;)V");
			IntPtr native_p1 = JNIEnv.NewString (p1);
			JValue* __args = stackalloc JValue [2];
			__args [0] = new JValue ((p0 == null) ? IntPtr.Zero : ((global::Java.Lang.Object) p0).Handle);
			__args [1] = new JValue (native_p1);
			JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_reqFwUpgrade2_Ljava_io_File_Ljava_lang_String_, __args);
			JNIEnv.DeleteLocalRef (native_p1);
		}
...
#pragma warning restore 0169
		...
		IntPtr id_reqSuspendFwUpgrade;
		public unsafe void ReqSuspendFwUpgrade ()
		{
			if (id_reqSuspendFwUpgrade == IntPtr.Zero)
				id_reqSuspendFwUpgrade = JNIEnv.GetMethodID (class_ref, "reqSuspendFwUpgrade", "()V");
			JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_reqSuspendFwUpgrade);
		}
...
#pragma warning restore 0169
		...
		IntPtr id_startListen;
		public unsafe void StartListen ()
		{
			if (id_startListen == IntPtr.Zero)
				id_startListen = JNIEnv.GetMethodID (class_ref, "startListen", "()V");
			JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_startListen);
		}
